...
use crate::{error::error::handle_db_error, models::submissions::{AssignmentSubmission, CreateSubmissionDto}};
...
pub async fn get_submissions_by_assignment(
    ...
    let submissions: Result<Vec<AssignmentSubmission>, sqlx::Error> = sqlx::query_as::<_, AssignmentSubmission>(
...
pub async fn get_submissions_by_user(
    ...
    let submissions: Result<Vec<AssignmentSubmission>, sqlx::Error> = sqlx::query_as::<_, AssignmentSubmission>(
        "SELECT * FROM get_submissions_by_user($1)"
    )
    .bind(id)
    .fetch_all(pool.get_ref())
    .await;
...
pub async fn create_submission(
    ...
    let result = sqlx::query(
        "SELECT create_submission($1, $2, $3, $4, $5, $6, $7, $8)"
    )
